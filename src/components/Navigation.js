        ...
        <nav>
            <div className="nav-wrapper">
				<ul className="hide-on-med-and-down">
					<li><a className="nav-tab" href="index.html">Home</a></li>
					<li><a className="nav-tab" href="#about-me">About Me</a></li>
					<li><a className="nav-tab" href="#portfolio">Portfolio</a></li>
